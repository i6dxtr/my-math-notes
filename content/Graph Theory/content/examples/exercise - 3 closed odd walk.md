...
### Relations
- Uses walk → path reduction and minimality arguments: [[content/theorems, lemma/lemma - walk contains path.md]], [[content/graph structure/walk, trail, path, cycle.md]].
- Formal version appears as: [[content/theorems, lemma/lemma - odd walk contains odd cycle.md]].
- Connected concepts: [[content/theorems, lemma/theorem - bipartite characterization.md]] (odd cycles obstruct bipartiteness), [[content/foundational/graph.md]].
