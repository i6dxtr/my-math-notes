...
### Relations
- Related foundational material: [[degree]], [[order, size]].
- Useful parity/degree results: [[handshake lemma]].
- See also: [[lemma - minimum degree 2 implies cycle]] for minimum-degree arguments in other contexts.
