...
### Relations
- Strengthens maximal-path arguments in [[content/graph structure/path.md|path]] and complements [[content/theorems, lemma/proposition - maximal paths & cycles.md|proposition - maximal paths & cycles]].
...
- These minimum-degree ideas are used in tree and spanning-tree exercises and interact with BFS/DFT constructions when reasoning about long paths and distances ([[content/foundational/tree.md|tree]], [[content/graph structure/algorithm - breadth-first search (BFS).md|BFS]], [[content/graph structure/algorithm - depth-first search (DFS).md|DFS]]).
- Minimum-degree and long-path arguments also inform matching and Tutte-style existence results introduced later in the course ([[content/foundational/matching.md|matching]], [[content/theorems, lemma/theorem - Tutte's theorem.md|Tutte's theorem]], [[content/theorems, lemma/theorem - matching + edge cover = n.md|theorem - matching + edge cover = n]]).
