...
### Relations
- Base concept: [[content/foundational/matching.md|matching]].
- Alternating/augmenting path definitions: [[content/foundational/M-alternating path, M-augmenting path.md|M-alternating path, M-augmenting path]].
- Used in the proof of the augmenting-path characterization of maximum matchings and in proofs such as Cantor–Schroeder–Bernstein via matching constructions ([[content/theorems, lemma/theorem - Cantor-Schroeder-Bernstein.md|Cantor–Schroeder–Bernstein]]).
