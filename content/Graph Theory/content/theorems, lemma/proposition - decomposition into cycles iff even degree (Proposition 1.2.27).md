...
- Eulerian circuit and characterization: [[content/theorems, lemma/theorem - eulerian circuit condition.md]]
- Uses cycles and trail definitions: [[content/graph structure/walk, trail, path, cycle.md]]
- Connected to decomposition techniques used in Tutte matching proofs and parity lemmas: see [[content/theorems, lemma/lemma - parity lemma (Tutte).md|parity lemma (Tutte)]], [[content/theorems, lemma/theorem - Tutte's theorem.md|Tutte's theorem]].
