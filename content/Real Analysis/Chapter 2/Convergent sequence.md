...
> [!example]
> ##### In $\mathbb{R}$:
> $( x_{n} )_{n\ge 1}$ is a sequence of real numbers, and $L$ is in $\mathbb{R}$.
> $$
> \begin{align} \lim_{n \to \infty}x_{n}=L\longleftrightarrow\forall\varepsilon>0,\ \exists n_{0}=n_{0}( \varepsilon ) \ \underline{\text{s.t.}}\\ \forall n\ge n_{0}, \lvert x_{n}-L \rvert<\varepsilon \end{align}
> $$
> 
> ---
> 
...
> [!theorem]
> Let $( a_{n} )_{n\ge1}$ and $( b_{n} )_{n\ge 1}$ be convergent sequences.
> $$
> \begin{align} 1.)&& \lim_{n \to \infty}a_{n}+b_{n}&=\lim_{n \to \infty}a_{n}+\lim_{n \to \infty}b_{n} \\ 2.)&& \lim_{n \to \infty}a_{n}b_{n} &=( \lim_{n \to \infty}a_{n} )( \lim_{n \to \infty}b_{n} ) \\ 3.)&& \lim_{n \to \infty}\frac{a_{n}}{b_{n}}&=\frac{\lim_{n \to \infty}a_{n}}{\lim_{n \to \infty}b_{n}}&&...\text{ if }\lim_{n \to \infty}b_{n}\ne0. \end{align}
> $$
...
> - Then:
> 	$$
> 	\begin{align} \lvert a_{n}b_{n}-ab \rvert &=\lvert a_{n}b_{n}-ab_{n}+ab_{n}-ab \rvert \\ &\le \lvert a_{n}-a \rvert \lvert b_{n} \rvert +\lvert b_{n}-b \rvert \lvert a \rvert \end{align}
> 	$$
> 	... or $\le \frac{\varepsilon}{2}+\frac{\varepsilon}{2}$?
