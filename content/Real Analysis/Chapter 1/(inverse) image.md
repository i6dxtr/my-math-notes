...
> 5. Let $f=\left\{ ( 1,-1 ),( 2,0 ),( 3,-5 ) \right\}$
> 	1. $F=\left\{ -1,-5 \right\}$
> 		1. then $f^{-1}( F )=\left\{ 1,3 \right\}$
> 	2. $F=\left\{ -1,-5,10 \right\}$
> 		2. then $f^{-1}=\left\{ 1,3 \right\}$
> 	3. $F=\mathbb{N}$
> 		1. then $f^{-1}( \emptyset )$
- note the [[function|logical properties of functions]] as they're related to the image/inverse image A
