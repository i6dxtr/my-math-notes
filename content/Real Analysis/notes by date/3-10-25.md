...
> 	- $\lim_{x \to 2}g( x )=4$
> 	- so $$\begin{align} \lvert g( x )-4 \rvert&=\left\lvert  \frac{x^{2}-4}{x-2}-4  \right\rvert \\ &=\left\lvert  \frac{x^{2}-4-4x+8}{x-2}  \right\rvert\\ &=\left\lvert  \frac{x^{2}-4x+4}{x-2}  \right\rvert\\ &=\left\lvert  \frac{( x-2 )^{2}}{( x-2 )}  \right\rvert \end{align}$$
> 	- where $x\ne 2$:
