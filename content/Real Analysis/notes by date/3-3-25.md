...
> [!theorem]
> Let $( a_{n} )$ and $( b_{n} )$ be sequences of real numbers. Then the following holds:
> $$
> \begin{align} \varliminf_{n \to \infty}a_{n}+\varliminf_{b \to \infty}b_{n}&\le \varliminf_{n \to \infty}( a_{n}+b_{n} ) \\ &\le \varliminf_{n \to \infty}a_{n}+\overline{\lim_{n \to \infty}}b_{n} \\ &\le \overline{\lim}( a_{n}+b_{n} ). \end{align}
> $$
