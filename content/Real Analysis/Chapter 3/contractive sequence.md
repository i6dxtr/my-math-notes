...
> - take
> 	$$
> 	\begin{align} \lvert a_{n+k}-a_{n} \rvert&=\lvert a_{n+k} -a_{n+k-1}+( a_{n+k-1}-a_{n+k-2} )+( a_{n+k-2}-a_{n+k-3} )+\cdots+( a_{n+1}-a_{n} )\rvert \\ &\le \lvert a_{n+k}-a_{n+k-1} \rvert +\lvert a_{n+k-1} \rvert +\cdots+ \lvert a_{n+1}-a_{n} \rvert  \end{align}
> 	$$
> - fix $k$ such that:
> 	$$
> 	\begin{align} \lvert a_{k+1}-a_{k} \rvert&\le b\lvert a_{k}-a_{k-1}\lvert\\ &\le b^{2} \lvert a_{k-1}-a_{k-2} \rvert \\ &\le b^{3}\lvert a_{k-2}-a_{k-3} \rvert \\ &\le \cdots \\ &\le b^{k}\lvert a_{2}-a_{1} \rvert \\ \lvert a_{n+k}-a_{n} \rvert &\le b^{n+k-2}\lvert a_{2}-a_{1} \rvert + b^{n+k-3}\lvert a_{2}-a_{1} \rvert +\cdots+ b^{n-1}\lvert a_{2}-a_{1} \rvert \\ &= ( b^{n+k-2}+b^{n+k-3}+\cdots+b^{n-1} )\lvert a_{2}-a_{1} \rvert \\ &=b^{n-1}( b^{k-1}+b^{k-1}+\cdots+1 )\lvert a_{2}-a_{1} \rvert \\ &= b^{n-1}\left(  \frac{1-b^{k}}{1-b}  \right)\le \frac{b^{n-1}}{1-b} \end{align}
> 	$$
> - Following,
> 	$$
> 	\begin{align} \lvert a_{n+k}-a_{n} \rvert\le \frac{b^{n-1}}{1-b} \\ \lim_{n \to \infty}b^{n-1}=0\ \  \end{align}
> 	$$
...
> - $( s_{n} )$ is not Cauchy:
> 	- $\begin{aligned} \lvert s_{m}-s_{n} \rvert&=\frac{1}{n+1}+\frac{1}{n+2}+\cdots+\frac{1}{m} \\ &\ge \frac{1}{m}( \text{number of terms} ) \end{aligned}$
> 	- Take $m=2n$, then:
> 		$$
> 		\begin{align} \lvert s_{2n}-s_{n} \rvert &\ge \frac{1}{2n}( n ) \\&= \frac{1}{2} \end{align}
> 		$$
> 		... so where $\varepsilon>0$, $\forall n_{0}$, $n\ge n_{0}$,
> 		$$\lvert s_{2n}-s_{n} \rvert \ge \frac{1}{2}.$$